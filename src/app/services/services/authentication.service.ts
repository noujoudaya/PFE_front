...
export class AuthenticationService extends BaseService {
   ...
   */
  register$Response(params: Register$Params, context?: HttpContext): Observable<StrictHttpResponse<EmptyResponse>> {
   ...
   * This method sends `application/json` and handles request body of type `application/json`.
   */
  register(params: Register$Params, context?: HttpContext): Observable<EmptyResponse> {
    return this.register$Response(params, context).pipe(
      map((r: StrictHttpResponse<EmptyResponse>): EmptyResponse => r.body)
    );
  }
